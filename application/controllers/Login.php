...
class Login extends CI_Controller
{
        ...
        if ($user) {
            ...
            if ($user['is_active'] == 1) {
                ...
                if (password_verify($password, $user['password'])) {
                    ...
                    $this->session->set_flashdata('messsage', '<div class="alert alert-danger" role="alert">Password Salah!</div>');
                    redirect('login');
                }
            } else {
            ...
            $this->session->set_flashdata('messsage', '<div class="alert alert-danger" role="alert">Email Belum Terdaftar!</div>');
            redirect('login');
        }
    }
    ...
    {         
        $this->session->unset_userdata('email');        
         ...
         $this->session->set_flashdata('messsage', '<div class="alert alert-success" role="alert">Selamat, kamu berhasil keluar!</div>');     
         redirect('login');    
    }
}